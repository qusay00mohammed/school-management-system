...
@section('title')
  {{ trans('trans_student.add student') }}
@stop
...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{ __('trans_student.add student') }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">{{ __('trans_main.home') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('trans_student.add student') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="card card-statistics h-100">
      <div class="card-body">
        <form method="post" action="{{ route('students.store') }}" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="datepicker-action" name="date_birthday"
                  data-date-format="yyyy-mm-dd" style="height: calc(2.25rem + 2px)">
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="custom-select mr-sm-2" name="parent_id">
                  <option selected disabled>{{ trans('trans_student.choose') }}...</option>
                  @foreach ($parent as $p)
                    <option value="{{ $p->id }}">{{ $p->father_name }}</option>
                  @endforeach
                </select>
              </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label for="">{{ trans('trans_student.images') }} : </label>
