...
@section('title')
{{ __('trans_fee.modification fee processing') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
  <div class="row">
    <div class="col-sm-6">
      <h4 class="mb-0"> {{ __('trans_fee.modification fee processing') }} <span style="color: red">{{ $processingFee->student->name }}</span></h4>
    </div>

    <div class="col-sm-6">
      <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
        <li class="breadcrumb-item"><a href="#" class="default-color">{{ __('trans_main.home') }}</a></li>
        <li class="breadcrumb-item active"> {{ __('trans_fee.modification fee processing') }}</li>
      </ol>
    </div>
  </div>
</div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" name="process" value="{{ $processingFee->amount }}" type="number">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="note" id="exampleFormControlTextarea1" rows="3">{{ $processingFee->note }}</textarea>
              </div>
            </div>
