...
class Show extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.question.show', ['data']);
    }
    ...
    public function nextQuestion($question_id, $score, $answer, $right_answer)
    {
        ...
        if ($stuDegree == null) {
            ...
            if ($stuDegree->question_id >= $this->data[$this->counter]->id) {
                ...
                $stuDegree->abuse = '1';
                $stuDegree->save();
                return redirect()->route('student.exam.index')->with('warning', __('trans_notification.system tampering'));
            } else {
        ...
        if ($this->counter < $this->questioncount - 1) {
            ...
            return redirect()->route('student.exam.index')->with('success', __('trans_notification.test completed successfully'));
        }
